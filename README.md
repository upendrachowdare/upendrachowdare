...
With over 16 years of hands-on experience, I design, architect, and deliver robust, scalable enterprise applications. As a Technical Lead and Architect, I specialize in bridging high-performance backend architectures (.NET Core / C#) with modern, responsive frontends (Angular / React), fully backed by cloud-native infrastructures.
...
| :--- | :--- |
| **Architecture & Backend** | .NET Core, C#, Microservices, REST APIs, Clean/Hexagonal Architecture, System Design |
| **Frontend Leadership** | Angular, React.js, TypeScript, JavaScript, HTML5/CSS3, Kendo UI |
| **Databases & Storage** | SQL Server, MongoDB, NoSQL, EF Core |
| **Cloud & DevOps** | Azure, AWS, CI/CD Pipelines, Docker, Containerization |
